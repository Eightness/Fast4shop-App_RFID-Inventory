...
public class FragmentTraspasos extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_traspasos, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        spOrigin = view.findViewById(R.id.spOrigin);
        spDestination = view.findViewById(R.id.spDestination);
        ...
        btnProcess.setOnClickListener(v -> processTraspaso());
    ...
    private void processTraspaso() {
        ...
        if (spOrigin.getSelectedItem() != null) origin = spOrigin.getSelectedItem().toString();
        if (spDestination.getSelectedItem() != null) destination = spDestination.getSelectedItem().toString();

        if (origin.equals(destination)) {
            Toast.makeText(mContext, "El almacén de origen y destino no pueden ser el mismo", Toast.LENGTH_LONG).show();
            return;
        }

        new AlertDialog.Builder(mContext)
                .setTitle("Procesar Traspaso")
                .setMessage("Se traspasarán " + scannedItems.size() + " items\nDe: " + origin + "\nA: " + destination)
                .setPositiveButton("Confirmar", (dialog, which) -> {
                    // Logic to save/send data
                    Toast.makeText(mContext, "Traspaso procesado correctamente", Toast.LENGTH_LONG).show();
                    clearData();
                })
